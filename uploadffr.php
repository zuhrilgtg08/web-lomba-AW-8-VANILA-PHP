            ...
            <div class="card-body px-sm-4 px-0">
                <div class="row justify-content-center mb-5">
                    <div class="col-md-10 col">
                        <h3 class="font-weight-bold ml-md-0 mx-auto text-center text-sm-left"> Upload File FFR </h3>
                    </div>
                </div>

<form name="form_masuk" method="POST" action="uploadffr_proses.php" enctype="multipart/form-data">
                        ...
                        <div class="card shadow-lg card-1">
                                ...
                                <div class="row justify-content-center">
                                   ...
                                   <div class="col-lg-5 col-md-6 col-sm-12">
                                    <div class="form-group"> <label for="last-name">Nama Tim</label> 
                                       <input type="text" class="form-control" name="ttim" id="Mobile-Number" placeholder="Nama Tim" required>
                                   </div>
                           ...
                           <div class="row justify-content-center">
                            <div class="col-md-12 col-lg-10 col-12">
                                <div class="form-group files"><label class="my-auto">Upload Link YouTube </label> 
                                    <input type="textarea" name="ffile" id="ffile"></div>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-md-12 col-lg-10 col-12">
