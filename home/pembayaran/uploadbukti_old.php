...
<?php if ($lomba == 'lkti') { ?>
        ...
        <section class="page-section">
            <div class="container">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col">
                            <h4 class="my-3">Unggah Scan Kartu Pelajar (format: *.jpg, *.png,) <span class="text-danger">*</span></h4>
                    ...
                    <div class="row">
                        <div class="col">
                            <h4 class="my-3">Bukti Upload Twibbon (format: *.jpg, *.png) <span class="text-danger">*<a href="https://bit.ly/TwibbonLKTIAW7" style="color: blue;" target="_blank"> Link Twibbon</a></span></h4>
                            <div class="input-group">
                                <div class="custom-file">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <select class="form-select" name="bidang" required>
                                        ...
                                        <option value="Gren ENERGY">Gren ENERGY</option>
                    ...
                    <div class="row">
                        <div class="col">
                            <h4 class="my-3">Judul Karya Tulis <span class="text-danger">*</span></h4>
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="text" class="form form-control" name="judul" placeholder="Judul Karya Tulis" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <h4 class="my-3">File Abstrak (ABSTRAK_AW7_Nama Lengkap Ketua_Nama Sekolah_Judul Karya Tulis:*.pdf)<span class="text-danger">*</span></h4>
                                <div class="input-group">
                                    <div class="custom-file">
    ...
    <?php } else if ($proses == 1) { ?>
        ...
        <div class="alert alert-success" role="alert">
            ...
            <a href="https://chat.whatsapp.com/LYQ0YWYRQgn3BhnXRlw9XK" style="color:blue;" target="_blank">Link Grup</a>
        </div>
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col">
                            ...
                            <ul>
                                <li>Shopeepay: 085745953419 atas nama Ega Aulia Safitr</li>
                                <li>Dana: 085745953419 atas nama Ega Aulia Safitr</li>
                                <li>BCA: 3890680185 atas nama Ega Aulia Safitri</li>
                            </ul>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <h4>Unggah Bukti Pembayaran (Transfer atas nama penyetor_AW7_Nama Lengkap Ketua_Nama Sekolah_Judul Karya Tulis: *.jpg, *.png, *.pdf)</h4>
                            <div class="input-group">
                                <div class="custom-file">
                    ...
                    <div class="row my-4">
                        <div class="col">
                            <h4>Upload File Full Paper (KARYA FULL PAPER_AW7_Nama Lengkap Ketua_Nama Sekolah_Judul Karya Tulis:*.pdf)</h4>
                            <div class="input-group">
                                <div class="custom-file">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <p>
                                ...
                                <a href="https://api.whatsapp.com/send/?phone=%2B6285745953419&text&app_absent=0" style="color: blue; text-decoration: none;" target="_blank">
                                    085745953419
                                </a>
                            </p>
                        </div>
...
<?php } else { ?>
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col">
                            <?php
                            if ($lomba == 'plc') {
                                $linktwibbon = 'https://bit.ly/twibbon-AW7-PLC';
                            } elseif ($lomba == 'lkti') {
                                $linktwibbon = 'https://bit.ly/TwibbonLKTIAW7';
                            } elseif ($lomba == 'ffr') {
                                $linktwibbon = 'https://bit.ly/twibbon-AW7-FFR';
                            }
                            ?>
    ...
    <?php } else if ($proses == 3) { ?>
        <div class="alert alert-success" role="alert">
            ...
            <?php
            if ($lomba == 'plc') {
                $linkGrup = 'https://chat.whatsapp.com/EpNEaRBbog1B2ycmeISZE4';
            } elseif ($lomba == 'lkti') {
                $linkGrup = 'https://chat.whatsapp.com/LYQ0YWYRQgn3BhnXRlw9XK';
            } elseif ($lomba == 'ffr') {
                $linkGrup = 'https://chat.whatsapp.com/EpNEaRBbog1B2ycmeISZE4';
            }
            ?>
