    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          $kon = new Koneksi();
          $id = @$_REQUEST['idpoint'];
          $abc = $kon->kueri("SELECT * FROM pengumuman_lkti WHERE id = '$id' ");
                      ...
                      <div class="col-lg">
                        <div class="p-5">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_tim" id="formGroupExampleInput" placeholder="Nama Tim" value="<?= $data['nama_tim'];  ?>" required>
                          </div>
                          <div class="form-group">
                            <label for="formGroupExampleInput">Nama Ketua</label>
                            <input type="text" class="form-control" name="nama_ketua" id="formGroupExampleInput" placeholder="Nama Tim" value="<?= $data['nama_ketua'];  ?>" required>
                          </div>
                          <div class="form-group">
                            <label for="formGroupExampleInput2">Asal Sekolah</label>
                            <input type="text" class="form-control" name="asal_sekolah" id="formGroupExampleInput2" placeholder="Asal Sekolah" value="<?= $data['asal_sekolah']; ?>" required>
                          </div>
                          <div class="form-group">
