...
switch ($aksi) {
	...
	//panggil kueri
	$abc = $kon->kueri ("UPDATE tl_ffr SET tgl_pendaftaran = '$daftar', tgl_pelatihan1 = '$latih1', tgl_pelatihan2 = '$latih2', tgl_seleksi1 = '$seleksi1', tgl_pengumuman1 = '$umum1', tgl_seleksi2 = '$seleksi2', tgl_pengumuman2 = '$umum2', tgl_tm = '$tm', tgl_lomba = '$lomba', tgl_penyisihan = '$penyisihan', tgl_final = '$final' WHERE id = '$idx' ");
	if($abc == TRUE) {
