                      ...
                      <div class="col-lg">
                        <div class="p-5">
                          <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4 " >Tambah Point FFR</h1>
                          </div>

                
                            <div class="form-group">
                              <label for="formGroupExampleInput">Nama Tim</label>
                              <input type="text" class="form-control" name="nama" id="formGroupExampleInput" placeholder="Nama Tim" required>
                            </div>
                            <div class="form-group">
                              <label for="formGroupExampleInput2">Asal Sekolah</label>
                              <input type="text" class="form-control" name="sekolah" id="formGroupExampleInput2" placeholder="Asal Sekolah" required>
                            </div>
                            <div class="form-group">
                              <label for="formGroupExampleInput2">Point Awal</label>
                              <input type="number" class="form-control" id="formGroupExampleInput2" placeholder="Poin Awal" name="point" required>
                            </div>
